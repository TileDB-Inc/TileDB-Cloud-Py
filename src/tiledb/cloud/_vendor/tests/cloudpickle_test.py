...
from tiledb.cloud._vendor.cloudpickle import list_registry_pickle_by_value
from tiledb.cloud._vendor.cloudpickle import register_pickle_by_value
from tiledb.cloud._vendor.cloudpickle import unregister_pickle_by_value
from tiledb.cloud._vendor.cloudpickle.cloudpickle import _extract_class_dict
from tiledb.cloud._vendor.cloudpickle.cloudpickle import _lookup_module_and_qualname
from tiledb.cloud._vendor.cloudpickle.cloudpickle import _make_empty_cell
from tiledb.cloud._vendor.cloudpickle.cloudpickle import _should_pickle_by_reference
from tiledb.cloud._vendor.cloudpickle.cloudpickle import _whichmodule
from tiledb.cloud._vendor.cloudpickle.cloudpickle import cell_set
...
pytestmark = pytest.mark.cloudpickle
...
class CloudPickleTest(unittest.TestCase):
    ...
    def test_locally_defined_function_and_class(self):
        ...
        self.assertEqual(
            pickle_depickle(some_function, protocol=self.protocol)(41, 1), 1
        )
        self.assertEqual(
            pickle_depickle(some_function, protocol=self.protocol)(81, 3), 2
        )
    ...
    def test_generator(self):
        ...
        assert type(gen2(3)) == type(some_generator(3))  # noqa: E721
    ...
    def test_load_dynamic_module_in_grandchild_process(self):
        ...
        child_process_script = """
            ...
            import tiledb.cloud._vendor.cloudpickle
            from testutils import assert_run_python_script
    ...
    def test_interactively_defined_global_variable(self):
        ...
        code_template = """\
        from testutils import subprocess_pickle_echo
        from tiledb.cloud._vendor.cloudpickle import dumps, loads
    ...
    def test_interactive_dynamic_type_and_stored_remote_instances(self):
        ...
        """
        code = """if __name__ == "__main__":
        import tiledb.cloud._vendor.cloudpickle, uuid
        from testutils import subprocess_worker
    ...
    def test_interactively_defined_func_with_positional_only_argument(self):
        ...
        code = """
        import pytest
        from tiledb.cloud._vendor.cloudpickle import loads, dumps
    ...
    def test_pickle_constructs_from_module_registered_for_pickling_by_value(
        ...
        try:
            ...
            with subprocess_worker(protocol=self.protocol) as w:
                ...
                from mock_local_folder.mod import LocalClass
                from mock_local_folder.mod import LocalT

                # The constructs whose pickling mechanism is changed using
                # register_pickle_by_value are functions, classes, TypeVar and
                # modules.
                from mock_local_folder.mod import local_function
                ...
                from mock_local_folder.subfolder.submod import LocalSubmodClass
                from mock_local_folder.subfolder.submod import LocalSubmodT
                from mock_local_folder.subfolder.submod import local_submod_function
