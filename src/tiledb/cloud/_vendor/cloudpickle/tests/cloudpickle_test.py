...
from tiledb.cloud._vendor.cloudpickle.cloudpickle import _make_empty_cell, cell_set
from tiledb.cloud._vendor.cloudpickle.cloudpickle import _extract_class_dict, _whichmodule
...
class CloudPickleTest(unittest.TestCase):
    ...
    def test_dynamic_pytest_module(self):
        ...
        # serializable.
        from tiledb.cloud._vendor.cloudpickle import CloudPickler
        from tiledb.cloud._vendor.cloudpickle import cloudpickle_fast as cp_fast
    ...
    @pytest.mark.xfail(reason="Growth is 8x too large on macOS")
