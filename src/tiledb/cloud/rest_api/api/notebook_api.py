...
class NotebookApi(object):
    ...
    def get_notebook_server_status(self, namespace, **kwargs):
        ...
        return self.get_notebook_server_status_with_http_info(namespace, **kwargs)

    def get_notebook_server_status_with_http_info(self, namespace, **kwargs):
        """get_notebook_server_status
    ...
    def handle_copy_notebook_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            or local_var_params["notebook_copy"] is None
        ):
            raise ApiValueError(
    ...
    def handle_upload_notebook_with_http_info(self, namespace, input_file, **kwargs):
        """handle_upload_notebook
    ...
    def shutdown_notebook_server(self, namespace, **kwargs):
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.shutdown_notebook_server_with_http_info(namespace, **kwargs)

    def shutdown_notebook_server_with_http_info(self, namespace, **kwargs):
        """shutdown_notebook_server
    ...
    def update_notebook_name_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            or local_var_params["notebook_metadata"] is None
        ):
            raise ApiValueError(
