...
class InvitationApi:
    ...
    def accept_invitation(self, invitation, **kwargs):
        ...
        return self.accept_invitation_with_http_info(invitation, **kwargs)

    def accept_invitation_with_http_info(self, invitation, **kwargs):
        """accept_invitation
        ...
        if "invitation" in local_var_params:
            path_params["invitation"] = local_var_params["invitation"]
    ...
    def cancel_share_group_by_invite(self, namespace, invitation, group_name, **kwargs):
    ...
    def cancel_share_payment(self, namespace, target, **kwargs):
        """cancel_share_payment

        Revokes invitation from the source namespace to the target.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cancel_share_payment(namespace, target, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str namespace: name or UUID of namespace sharing their payment info (required)
        :param str target: name or UUID of recipient namespace (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.cancel_share_payment_with_http_info(namespace, target, **kwargs)

    def cancel_share_payment_with_http_info(self, namespace, target, **kwargs):
        """cancel_share_payment

        Revokes invitation from the source namespace to the target.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cancel_share_payment_with_http_info(namespace, target, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in local_var_params["kwargs"].items():
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cancel_share_payment" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        # verify the required parameter 'namespace' is set
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `namespace` when calling `cancel_share_payment`"
            )
        # verify the required parameter 'target' is set
        if self.api_client.client_side_validation and (
            "target" not in local_var_params or local_var_params["target"] is None
        ):
            raise ApiValueError(
                "Missing the required parameter `target` when calling `cancel_share_payment`"
            )
        ...
        return self.api_client.call_api(
            "/v1/invitations/share_payment/{namespace}/{target}",
            "DELETE",
            path_params,
            query_params,
            header_params,
    ...
    def fetch_invitations(self, **kwargs):
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.fetch_invitations_with_http_info(**kwargs)

    def fetch_invitations_with_http_info(self, **kwargs):
        """fetch_invitations
        ...
        if "group" in local_var_params and local_var_params["group"] is not None:
    ...
    def join_organization_with_http_info(self, organization, email_invite, **kwargs):
        """join_organization
    ...
    def share_group_by_invite(self, namespace, group, email_invite, **kwargs):
    ...
    def share_payment(self, namespace, **kwargs):
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.share_payment_with_http_info(namespace, **kwargs)

    def share_payment_with_http_info(self, namespace, **kwargs):
        """share_payment

        Sends email to multiple recipients allowing them to use the payment instrument provided by the source namespace.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.share_payment_with_http_info(namespace, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["namespace", "email_invite"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `namespace` when calling `share_payment`"
            )
        ...
        return self.api_client.call_api(
            "/v1/invitations/share_payment/{namespace}",
            "POST",
            path_params,
            query_params,
            header_params,
