...
class GroupInfo(object):
    ...
    @property
    def namespace(self):
        """Gets the namespace of this GroupInfo.

        namespace group is in

        :return: The namespace of this GroupInfo.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        ...
        :param namespace: The namespace of this GroupInfo.
        :type: str
        """
    ...
    @property
    def uri(self):
        """Gets the uri of this GroupInfo.

        uri of group

        :return: The uri of this GroupInfo.
        :rtype: str
        """
        return self._uri
    ...
    def uri(self, uri):
        ...
        :param uri: The uri of this GroupInfo.
        :type: str
        """
    ...
    @property
    def tiledb_uri(self):
        """Gets the tiledb_uri of this GroupInfo.

        uri for access through TileDB cloud

        :return: The tiledb_uri of this GroupInfo.
        :rtype: str
        """
    ...
    def tiledb_uri(self, tiledb_uri):
        ...
        :param tiledb_uri: The tiledb_uri of this GroupInfo.
        :type: str
        """
    ...
    def asset_count(self):
        """Gets the asset_count of this GroupInfo.

        A count of direct array members

        :return: The asset_count of this GroupInfo.
        :rtype: float
        """
    ...
    def asset_count(self, asset_count):
        ...
        :param asset_count: The asset_count of this GroupInfo.
        :type: float
        """
    ...
    def group_count(self):
        """Gets the group_count of this GroupInfo.

        A count of direct group members

        :return: The group_count of this GroupInfo.
        :rtype: float
        """
    ...
    def group_count(self, group_count):
        ...
        :param group_count: The group_count of this GroupInfo.
        :type: float
        """
    ...
    def size(self, size):
        ...
        :param size: The size of this GroupInfo.
        :type: float
        """
    ...
    def last_accessed(self):
        """Gets the last_accessed of this GroupInfo.

        Datetime groups was last accessed in UTC

        :return: The last_accessed of this GroupInfo.
        :rtype: datetime
        """
    ...
    def last_accessed(self, last_accessed):
        ...
        :param last_accessed: The last_accessed of this GroupInfo.
        :type: datetime
        """
    ...
    def allowed_actions(self):
        """Gets the allowed_actions of this GroupInfo.

        list of actions user is allowed to do on this group

        :return: The allowed_actions of this GroupInfo.
    ...
    def allowed_actions(self, allowed_actions):
        ...
        :param allowed_actions: The allowed_actions of this GroupInfo.
    ...
    @property
    def group_type(self):
        """Gets the group_type of this GroupInfo.


        :return: The group_type of this GroupInfo.
        :rtype: GroupType
        """
    ...
    def group_type(self, group_type):
        ...
        :param group_type: The group_type of this GroupInfo.
        :type: GroupType
        """
    ...
    @property
    def logo(self):
        """Gets the logo of this GroupInfo.

        logo (base64 encoded) for the gruop. Optional

        :return: The logo of this GroupInfo.
        :rtype: str
        """
        return self._logo
    ...
    def logo(self, logo):
        ...
        :param logo: The logo of this GroupInfo.
        :type: str
        """
    ...
    def access_credentials_name(self):
        """Gets the access_credentials_name of this GroupInfo.

        the name of the access credentials to use. if unset, the default credentials will be used

        :return: The access_credentials_name of this GroupInfo.
        :rtype: str
        """
    ...
    def access_credentials_name(self, access_credentials_name):
        ...
        :param access_credentials_name: The access_credentials_name of this GroupInfo.
        :type: str
        """
    ...
    def share_count(self):
        """Gets the share_count of this GroupInfo.

        number of unique namespaces this group is shared with

        :return: The share_count of this GroupInfo.
        :rtype: float
        """
    ...
    def share_count(self, share_count):
        ...
        :param share_count: The share_count of this GroupInfo.
        :type: float
        """
    ...
    def public_share(self):
        """Gets the public_share of this GroupInfo.

        Suggests if the group was shared to public by owner

        :return: The public_share of this GroupInfo.
        :rtype: bool
        """
    ...
    def public_share(self, public_share):
        ...
        :param public_share: The public_share of this GroupInfo.
        :type: bool
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this GroupInfo.

        optional tags for group

        :return: The tags of this GroupInfo.
        :rtype: list[str]
        """
        return self._tags
    ...
    def tags(self, tags):
        ...
        :param tags: The tags of this GroupInfo.
        :type: list[str]
        """
    ...
    @property
    def license_id(self):
        """Gets the license_id of this GroupInfo.

        License identifier from SPDX License List or Custom

        :return: The license_id of this GroupInfo.
        :rtype: str
        """
    ...
    def license_id(self, license_id):
        ...
        :param license_id: The license_id of this GroupInfo.
        :type: str
        """
    ...
    def license_text(self):
        """Gets the license_text of this GroupInfo.

        License text

        :return: The license_text of this GroupInfo.
        :rtype: str
        """
    ...
    def license_text(self, license_text):
        ...
        :param license_text: The license_text of this GroupInfo.
        :type: str
        """
    ...
    @property
    def created_at(self):
        """Gets the created_at of this GroupInfo.

        Datetime the group was registered with tiledb

        :return: The created_at of this GroupInfo.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        ...
        :param created_at: The created_at of this GroupInfo.
        :type: datetime
        """
