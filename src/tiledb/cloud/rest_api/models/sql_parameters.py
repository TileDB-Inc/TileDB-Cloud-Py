...
class SQLParameters(object):
    ...
    def __init__(
        ...
        """SQLParameters - a model defined in OpenAPI"""
    ...
    @property
    def name(self):
        """Gets the name of this SQLParameters.

        name of task, optional

        :return: The name of this SQLParameters.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this SQLParameters.
        :type: str
        """
    ...
    @property
    def query(self):
        """Gets the query of this SQLParameters.

        query to run

        :return: The query of this SQLParameters.
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        ...
        :param query: The query of this SQLParameters.
        :type: str
        """
    ...
    @property
    def output_uri(self):
        """Gets the output_uri of this SQLParameters.

        Output array uri

        :return: The output_uri of this SQLParameters.
        :rtype: str
        """
    ...
    def output_uri(self, output_uri):
        ...
        :param output_uri: The output_uri of this SQLParameters.
        :type: str
        """
    ...
    def store_results(self):
        """Gets the store_results of this SQLParameters.

        store results for later retrieval

        :return: The store_results of this SQLParameters.
        :rtype: bool
        """
    ...
    def store_results(self, store_results):
        ...
        :param store_results: The store_results of this SQLParameters.
        :type: bool
        """
    ...
    def dont_download_results(self):
        """Gets the dont_download_results of this SQLParameters.
        ...
        :return: The dont_download_results of this SQLParameters.
        :rtype: bool
        """
    ...
    def dont_download_results(self, dont_download_results):
        ...
        :param dont_download_results: The dont_download_results of this SQLParameters.
        :type: bool
        """
    ...
    def resource_class(self):
        """Gets the resource_class of this SQLParameters.
        ...
        :return: The resource_class of this SQLParameters.
        :rtype: str
        """
    ...
    def resource_class(self, resource_class):
        ...
        :param resource_class: The resource_class of this SQLParameters.
        :type: str
        """
    ...
    def result_format(self):
        """Gets the result_format of this SQLParameters.


        :return: The result_format of this SQLParameters.
        :rtype: ResultFormat
        """
    ...
    def result_format(self, result_format):
        ...
        :param result_format: The result_format of this SQLParameters.
        :type: ResultFormat
        """
    ...
    def init_commands(self):
        """Gets the init_commands of this SQLParameters.

        Queries or commands to run before main query

        :return: The init_commands of this SQLParameters.
        :rtype: list[str]
        """
    ...
    def init_commands(self, init_commands):
        ...
        :param init_commands: The init_commands of this SQLParameters.
        :type: list[str]
        """
    ...
    @property
    def parameters(self):
        """Gets the parameters of this SQLParameters.

        SQL query parameters

        :return: The parameters of this SQLParameters.
        :rtype: list[object]
        """
    ...
    def parameters(self, parameters):
        ...
        :param parameters: The parameters of this SQLParameters.
        :type: list[object]
        """
    ...
    def task_graph_uuid(self):
        """Gets the task_graph_uuid of this SQLParameters.

        If set, the ID of the log for the task graph that this was part of.

        :return: The task_graph_uuid of this SQLParameters.
        :rtype: str
        """
    ...
    def task_graph_uuid(self, task_graph_uuid):
        ...
        :param task_graph_uuid: The task_graph_uuid of this SQLParameters.
        :type: str
        """
    ...
    def client_node_uuid(self):
        """Gets the client_node_uuid of this SQLParameters.

        If set, the client-defined ID of the node within this task's graph.

        :return: The client_node_uuid of this SQLParameters.
        :rtype: str
        """
    ...
    def client_node_uuid(self, client_node_uuid):
        ...
        :param client_node_uuid: The client_node_uuid of this SQLParameters.
        :type: str
        """
