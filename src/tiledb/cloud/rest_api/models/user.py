...
class User(object):
    ...
    def is_valid_email(self):
        """Gets the is_valid_email of this User.

        user's email is validated to be correct

        :return: The is_valid_email of this User.
        :rtype: bool
        """
    ...
    def is_valid_email(self, is_valid_email):
        ...
        :param is_valid_email: The is_valid_email of this User.
        :type: bool
        """
    ...
    def stripe_connect(self, stripe_connect):
        ...
        :param stripe_connect: The stripe_connect of this User.
        :type: bool
        """
    ...
    @property
    def logo(self):
        """Gets the logo of this User.

        the user's logo

        :return: The logo of this User.
        :rtype: str
        """
        return self._logo
    ...
    def logo(self, logo):
        ...
        :param logo: The logo of this User.
        :type: str
        """
    ...
    def allowed_actions(self):
        """Gets the allowed_actions of this User.

        list of actions user is allowed to do on this organization

        :return: The allowed_actions of this User.
    ...
    def allowed_actions(self, allowed_actions):
        ...
        :param allowed_actions: The allowed_actions of this User.
    ...
    def enabled_features(self):
        """Gets the enabled_features of this User.

        List of extra/optional/beta features to enable for namespace

        :return: The enabled_features of this User.
        :rtype: list[str]
        """
    ...
    def enabled_features(self, enabled_features):
        ...
        :param enabled_features: The enabled_features of this User.
        :type: list[str]
        """
    ...
    def unpaid_subscription(self):
        """Gets the unpaid_subscription of this User.

        A notice that the user has an unpaid subscription

        :return: The unpaid_subscription of this User.
        :rtype: bool
        """
    ...
    def unpaid_subscription(self, unpaid_subscription):
        ...
        :param unpaid_subscription: The unpaid_subscription of this User.
        :type: bool
        """
    ...
    def default_s3_path(self):
        """Gets the default_s3_path of this User.
        ...
        :return: The default_s3_path of this User.
        :rtype: str
        """
    ...
    def default_s3_path(self, default_s3_path):
        ...
        :param default_s3_path: The default_s3_path of this User.
        :type: str
        """
    ...
    def default_s3_path_credentials_name(self):
        """Gets the default_s3_path_credentials_name of this User.

        The name of the credentials used to create and access files in the `default_s3_path`, if needed.

        :return: The default_s3_path_credentials_name of this User.
        :rtype: object
        """
    ...
    def default_s3_path_credentials_name(self, default_s3_path_credentials_name):
        ...
        :param default_s3_path_credentials_name: The default_s3_path_credentials_name of this User.
        :type: object
        """
    ...
    def asset_locations(self):
        """Gets the asset_locations of this User.


        :return: The asset_locations of this User.
    ...
    def asset_locations(self, asset_locations):
        ...
        :param asset_locations: The asset_locations of this User.
        :type: AssetLocations
        """
    ...
    def default_namespace_charged(self):
        """Gets the default_namespace_charged of this User.

        Override the default namespace charged for actions when no namespace is specified

        :return: The default_namespace_charged of this User.
        :rtype: str
        """
    ...
    def default_namespace_charged(self, default_namespace_charged):
        ...
        :param default_namespace_charged: The default_namespace_charged of this User.
        :type: str
        """
    ...
    def default_region(self):
        """Gets the default_region of this User.
        ...
        :return: The default_region of this User.
        :rtype: str
        """
    ...
    def default_region(self, default_region):
        ...
        :param default_region: The default_region of this User.
        :type: str
        """
