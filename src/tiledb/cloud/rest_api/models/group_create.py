...
class GroupCreate:
    ...
    def parent(self, parent):
        """Sets the parent of this GroupCreate.

        The unique name or id of the parent of the group. If empty, then the new group will be a top level group.

        :param parent: The parent of this GroupCreate.
        :type: str
        """
    ...
    @property
    def uri(self):
        """Gets the uri of this GroupCreate.

        uri of group.

        :return: The uri of this GroupCreate.
        :rtype: str
        """
        return self._uri
    ...
    @uri.setter
    def uri(self, uri):
        """Sets the uri of this GroupCreate.

        uri of group.

        :param uri: The uri of this GroupCreate.
        :type: str
        """
    ...
    @property
    def logo(self):
        """Gets the logo of this GroupCreate.

        logo (base64 encoded) for the group. Optional

        :return: The logo of this GroupCreate.
        :rtype: str
        """
        return self._logo
    ...
    @logo.setter
    def logo(self, logo):
        """Sets the logo of this GroupCreate.

        logo (base64 encoded) for the group. Optional

        :param logo: The logo of this GroupCreate.
        :type: str
        """
    ...
    def access_credentials_name(self):
        """Gets the access_credentials_name of this GroupCreate.

        the name of the access credentials to use. if unset, the default credentials will be used.

        :return: The access_credentials_name of this GroupCreate.
        :rtype: str
        """
    ...
    def access_credentials_name(self, access_credentials_name):
        """Sets the access_credentials_name of this GroupCreate.

        the name of the access credentials to use. if unset, the default credentials will be used.

        :param access_credentials_name: The access_credentials_name of this GroupCreate.
        :type: str
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this GroupCreate.

        optional tags for groups.

        :return: The tags of this GroupCreate.
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this GroupCreate.

        optional tags for groups.

        :param tags: The tags of this GroupCreate.
        :type: list[str]
        """
    ...
    @property
    def license_id(self):
        """Gets the license_id of this GroupCreate.

        License identifier from SPDX License List or Custom.

        :return: The license_id of this GroupCreate.
        :rtype: str
        """
    ...
    def license_id(self, license_id):
        """Sets the license_id of this GroupCreate.

        License identifier from SPDX License List or Custom.

        :param license_id: The license_id of this GroupCreate.
        :type: str
        """
    ...
    def license_text(self):
        """Gets the license_text of this GroupCreate.

        License text

        :return: The license_text of this GroupCreate.
        :rtype: str
        """
    ...
    def license_text(self, license_text):
        """Sets the license_text of this GroupCreate.

        License text

        :param license_text: The license_text of this GroupCreate.
        :type: str
        """
