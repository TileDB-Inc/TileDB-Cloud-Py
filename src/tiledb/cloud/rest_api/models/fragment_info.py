...
class FragmentInfo(object):
    ...
    def __init__(
        ...
        """FragmentInfo - a model defined in OpenAPI"""
    ...
    def array_schema_all(self):
        """Gets the array_schema_all of this FragmentInfo.

        map of all array schemas

        :return: The array_schema_all of this FragmentInfo.
    ...
    def array_schema_all(self, array_schema_all):
        ...
        :param array_schema_all: The array_schema_all of this FragmentInfo.
    ...
    def fragment_info(self):
        """Gets the fragment_info of this FragmentInfo.

        information about fragments in the array

        :return: The fragment_info of this FragmentInfo.
    ...
    def fragment_info(self, fragment_info):
        ...
        :param fragment_info: The fragment_info of this FragmentInfo.
    ...
    @property
    def to_vacuum(self):
        """Gets the to_vacuum of this FragmentInfo.

        the URIs of the fragments to vacuum

        :return: The to_vacuum of this FragmentInfo.
        :rtype: list[str]
        """
    ...
    def to_vacuum(self, to_vacuum):
        ...
        :param to_vacuum: The to_vacuum of this FragmentInfo.
        :type: list[str]
        """
