...
class GroupSharingRequest(object):
    ...
    def __init__(
        ...
        """GroupSharingRequest - a model defined in OpenAPI"""
    ...
    def group_actions(self):
        """Gets the group_actions of this GroupSharingRequest.

        List of permitted actions for the group and all subgroups

        :return: The group_actions of this GroupSharingRequest.
    ...
    def group_actions(self, group_actions):
        ...
        :param group_actions: The group_actions of this GroupSharingRequest.
    ...
    def array_actions(self):
        """Gets the array_actions of this GroupSharingRequest.

        List of permitted actions for all the subarrays of the group

        :return: The array_actions of this GroupSharingRequest.
    ...
    def array_actions(self, array_actions):
        ...
        :param array_actions: The array_actions of this GroupSharingRequest.
    ...
    @property
    def namespace(self):
        """Gets the namespace of this GroupSharingRequest.

        namespace being granted group access can be a user or organization

        :return: The namespace of this GroupSharingRequest.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        ...
        :param namespace: The namespace of this GroupSharingRequest.
        :type: str
        """
