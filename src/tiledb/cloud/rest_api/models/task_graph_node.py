...
class TaskGraphNode(object):
    ...
    def __init__(
        ...
        """TaskGraphNode - a model defined in OpenAPI"""
    ...
    def client_node_id(self):
        """Gets the client_node_id of this TaskGraphNode.

        The client-generated UUID of the given graph node.

        :return: The client_node_id of this TaskGraphNode.
        :rtype: str
        """
    ...
    def client_node_id(self, client_node_id):
        ...
        :param client_node_id: The client_node_id of this TaskGraphNode.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this TaskGraphNode.

        A client-specified name for the node. If provided, this must be unique.

        :return: The name of this TaskGraphNode.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this TaskGraphNode.
        :type: str
        """
    ...
    def depends_on(self, depends_on):
        ...
        :param depends_on: The depends_on of this TaskGraphNode.
        :type: list[str]
        """
    ...
    @property
    def array_node(self):
        """Gets the array_node of this TaskGraphNode.


        :return: The array_node of this TaskGraphNode.
    ...
    def array_node(self, array_node):
        ...
        :param array_node: The array_node of this TaskGraphNode.
    ...
    @property
    def input_node(self):
        """Gets the input_node of this TaskGraphNode.


        :return: The input_node of this TaskGraphNode.
    ...
    def input_node(self, input_node):
        ...
        :param input_node: The input_node of this TaskGraphNode.
    ...
    @property
    def sql_node(self):
        """Gets the sql_node of this TaskGraphNode.


        :return: The sql_node of this TaskGraphNode.
        :rtype: TGSQLNodeData
        """
    ...
    def sql_node(self, sql_node):
        ...
        :param sql_node: The sql_node of this TaskGraphNode.
        :type: TGSQLNodeData
        """
    ...
    @property
    def udf_node(self):
        """Gets the udf_node of this TaskGraphNode.


        :return: The udf_node of this TaskGraphNode.
        :rtype: TGUDFNodeData
        """
    ...
    def udf_node(self, udf_node):
        ...
        :param udf_node: The udf_node of this TaskGraphNode.
        :type: TGUDFNodeData
        """
    ...
    def retry_strategy(self):
        """Gets the retry_strategy of this TaskGraphNode.


        :return: The retry_strategy of this TaskGraphNode.
        :rtype: RetryStrategy
        """
    ...
    def retry_strategy(self, retry_strategy):
        ...
        :param retry_strategy: The retry_strategy of this TaskGraphNode.
        :type: RetryStrategy
        """
    ...
    def expand_node_output(self):
        """Gets the expand_node_output of this TaskGraphNode.
        ...
        :return: The expand_node_output of this TaskGraphNode.
        :rtype: str
        """
    ...
    def expand_node_output(self, expand_node_output):
        ...
        :param expand_node_output: The expand_node_output of this TaskGraphNode.
        :type: str
        """
    ...
    def deadline(self, deadline):
        ...
        :param deadline: The deadline of this TaskGraphNode.
        :type: int
        """
