...
class InvitationArrayShareEmail:
    ...
    def __init__(self, actions=None, invitee_email=None, local_vars_configuration=None):
        """InvitationArrayShareEmail - a model defined in OpenAPI"""
    ...
    @property
    def actions(self):
        """Gets the actions of this InvitationArrayShareEmail.

        List of permitted actions

        :return: The actions of this InvitationArrayShareEmail.
    ...
    def actions(self, actions):
        ...
        :param actions: The actions of this InvitationArrayShareEmail.
        :type: list[ArrayActions]
        """
        if self.local_vars_configuration.client_side_validation and actions is None:
    ...
    def invitee_email(self):
        """Gets the invitee_email of this InvitationArrayShareEmail.


        :return: The invitee_email of this InvitationArrayShareEmail.
        :rtype: list[str]
        """
    ...
    def invitee_email(self, invitee_email):
        ...
        :param invitee_email: The invitee_email of this InvitationArrayShareEmail.
        :type: list[str]
        """
        if (
