...
class Subscription(object):
    ...
    def owner_namespace_uuid(self):
        """Gets the owner_namespace_uuid of this Subscription.

        Unique ID of the array (product) owner

        :return: The owner_namespace_uuid of this Subscription.
        :rtype: str
        """
    ...
    def owner_namespace_uuid(self, owner_namespace_uuid):
        ...
        :param owner_namespace_uuid: The owner_namespace_uuid of this Subscription.
        :type: str
        """
    ...
    def customer_namespace_uuid(self):
        """Gets the customer_namespace_uuid of this Subscription.

        Unique ID of the array (product) user (customer)

        :return: The customer_namespace_uuid of this Subscription.
        :rtype: str
        """
    ...
    def customer_namespace_uuid(self, customer_namespace_uuid):
        ...
        :param customer_namespace_uuid: The customer_namespace_uuid of this Subscription.
        :type: str
        """
    ...
    @property
    def pricing(self):
        """Gets the pricing of this Subscription.

        list of pricing used by this subscription

        :return: The pricing of this Subscription.
        :rtype: list[Pricing]
        """
    ...
    def pricing(self, pricing):
        ...
        :param pricing: The pricing of this Subscription.
        :type: list[Pricing]
        """
