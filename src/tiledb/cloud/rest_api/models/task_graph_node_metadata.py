...
class TaskGraphNodeMetadata(object):
    ...
    def __init__(
        ...
        """TaskGraphNodeMetadata - a model defined in OpenAPI"""
    ...
    def client_node_uuid(self):
        """Gets the client_node_uuid of this TaskGraphNodeMetadata.

        The client-generated UUID of the given graph node.

        :return: The client_node_uuid of this TaskGraphNodeMetadata.
        :rtype: str
        """
    ...
    def client_node_uuid(self, client_node_uuid):
        ...
        :param client_node_uuid: The client_node_uuid of this TaskGraphNodeMetadata.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this TaskGraphNodeMetadata.

        The client-generated name of the node. This is not guaranteed to be unique.

        :return: The name of this TaskGraphNodeMetadata.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this TaskGraphNodeMetadata.
        :type: str
        """
    ...
    def depends_on(self, depends_on):
        ...
        :param depends_on: The depends_on of this TaskGraphNodeMetadata.
        :type: list[str]
        """
    ...
    def run_location(self):
        """Gets the run_location of this TaskGraphNodeMetadata.


        :return: The run_location of this TaskGraphNodeMetadata.
    ...
    def run_location(self, run_location):
        ...
        :param run_location: The run_location of this TaskGraphNodeMetadata.
    ...
    @property
    def status(self):
        """Gets the status of this TaskGraphNodeMetadata.


        :return: The status of this TaskGraphNodeMetadata.
    ...
    def status(self, status):
        ...
        :param status: The status of this TaskGraphNodeMetadata.
    ...
    def status_message(self):
        """Gets the status_message of this TaskGraphNodeMetadata.

        The reason the array task status is in the state

        :return: The status_message of this TaskGraphNodeMetadata.
        :rtype: str
        """
    ...
    def status_message(self, status_message):
        ...
        :param status_message: The status_message of this TaskGraphNodeMetadata.
        :type: str
        """
    ...
    @property
    def executions(self):
        """Gets the executions of this TaskGraphNodeMetadata.
        ...
        :return: The executions of this TaskGraphNodeMetadata.
    ...
    def executions(self, executions):
        ...
        :param executions: The executions of this TaskGraphNodeMetadata.
        :type: list[ArrayTask]
        """
