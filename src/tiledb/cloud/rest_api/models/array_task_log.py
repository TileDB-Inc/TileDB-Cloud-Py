...
class ArrayTaskLog:
    ...
    def __init__(self, array_task_id=None, logs=None, local_vars_configuration=None):
        """ArrayTaskLog - a model defined in OpenAPI"""
    ...
    def array_task_id(self):
        """Gets the array_task_id of this ArrayTaskLog.

        ID of associated task

        :return: The array_task_id of this ArrayTaskLog.
        :rtype: str
        """
    ...
    def array_task_id(self, array_task_id):
        ...
        :param array_task_id: The array_task_id of this ArrayTaskLog.
        :type: str
        """
    ...
    @property
    def logs(self):
        """Gets the logs of this ArrayTaskLog.

        logs from array task

        :return: The logs of this ArrayTaskLog.
        :rtype: str
        """
        return self._logs
    ...
    def logs(self, logs):
        ...
        :param logs: The logs of this ArrayTaskLog.
        :type: str
        """
