...
class QueryReader(object):
    ...
    def __init__(
        ...
        """QueryReader - a model defined in OpenAPI"""
    ...
    @property
    def layout(self):
        """Gets the layout of this QueryReader.


        :return: The layout of this QueryReader.
        :rtype: Layout
        """
        return self._layout
    ...
    def layout(self, layout):
        ...
        :param layout: The layout of this QueryReader.
        :type: Layout
        """
    ...
    @property
    def subarray(self):
        """Gets the subarray of this QueryReader.


        :return: The subarray of this QueryReader.
        :rtype: Subarray
        """
    ...
    def subarray(self, subarray):
        ...
        :param subarray: The subarray of this QueryReader.
        :type: Subarray
        """
    ...
    @property
    def read_state(self):
        """Gets the read_state of this QueryReader.


        :return: The read_state of this QueryReader.
        :rtype: ReadState
        """
    ...
    def read_state(self, read_state):
        ...
        :param read_state: The read_state of this QueryReader.
        :type: ReadState
        """
    ...
    def var_offsets_mode(self):
        """Gets the var_offsets_mode of this QueryReader.

        The offsets format (bytes or elements) to be used.

        :return: The var_offsets_mode of this QueryReader.
        :rtype: str
        """
    ...
    def var_offsets_mode(self, var_offsets_mode):
        ...
        :param var_offsets_mode: The var_offsets_mode of this QueryReader.
        :type: str
        """
    ...
    def var_offsets_add_extra_element(self):
        """Gets the var_offsets_add_extra_element of this QueryReader.

        True if an extra element will be added to the end of the offsets buffer.

        :return: The var_offsets_add_extra_element of this QueryReader.
        :rtype: bool
        """
    ...
    def var_offsets_add_extra_element(self, var_offsets_add_extra_element):
        ...
        :param var_offsets_add_extra_element: The var_offsets_add_extra_element of this QueryReader.
        :type: bool
        """
    ...
    def var_offsets_bitsize(self):
        """Gets the var_offsets_bitsize of this QueryReader.

        The offsets bitsize (32 or 64) to be used.

        :return: The var_offsets_bitsize of this QueryReader.
        :rtype: int
        """
    ...
    def var_offsets_bitsize(self, var_offsets_bitsize):
        ...
        :param var_offsets_bitsize: The var_offsets_bitsize of this QueryReader.
        :type: int
        """
