...
class SSODomainConfigResponse:
    ...
    def __init__(self, domain_configs=None, local_vars_configuration=None):
        """SSODomainConfigResponse - a model defined in OpenAPI"""
    ...
    def domain_configs(self):
        """Gets the domain_configs of this SSODomainConfigResponse.


        :return: The domain_configs of this SSODomainConfigResponse.
    ...
    def domain_configs(self, domain_configs):
        ...
        :param domain_configs: The domain_configs of this SSODomainConfigResponse.
