...
class NotebookFavorite:
    ...
    def __init__(
        ...
        """NotebookFavorite - a model defined in OpenAPI"""
    ...
    def notebook_uuid(self):
        """Gets the notebook_uuid of this NotebookFavorite.

        unique UUID of the notebook

        :return: The notebook_uuid of this NotebookFavorite.
        :rtype: str
        """
    ...
    def notebook_uuid(self, notebook_uuid):
        ...
        :param notebook_uuid: The notebook_uuid of this NotebookFavorite.
        :type: str
        """
    ...
    @property
    def namespace(self):
        """Gets the namespace of this NotebookFavorite.

        the namespace of the notebook

        :return: The namespace of this NotebookFavorite.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        ...
        :param namespace: The namespace of this NotebookFavorite.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this NotebookFavorite.

        the name of the notebook

        :return: The name of this NotebookFavorite.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this NotebookFavorite.
        :type: str
        """
