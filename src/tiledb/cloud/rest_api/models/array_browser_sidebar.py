...
class ArrayBrowserSidebar:
    ...
    def __init__(
        ...
        """ArrayBrowserSidebar - a model defined in OpenAPI"""
    ...
    @property
    def namespaces(self):
        """Gets the namespaces of this ArrayBrowserSidebar.

        list of all unique namespaces to display

        :return: The namespaces of this ArrayBrowserSidebar.
        :rtype: list[str]
        """
    ...
    def namespaces(self, namespaces):
        ...
        :param namespaces: The namespaces of this ArrayBrowserSidebar.
        :type: list[str]
        """
    ...
    def result_count_for_all(self):
        """Gets the result_count_for_all of this ArrayBrowserSidebar.

        A count of \"all\" of category

        :return: The result_count_for_all of this ArrayBrowserSidebar.
        :rtype: int
        """
    ...
    def result_count_for_all(self, result_count_for_all):
        ...
        :param result_count_for_all: The result_count_for_all of this ArrayBrowserSidebar.
        :type: int
        """
    ...
    def result_count_by_namespace(self):
        """Gets the result_count_by_namespace of this ArrayBrowserSidebar.

        A map that includes the result count by namespace

        :return: The result_count_by_namespace of this ArrayBrowserSidebar.
        :rtype: object
        """
    ...
    def result_count_by_namespace(self, result_count_by_namespace):
        ...
        :param result_count_by_namespace: The result_count_by_namespace of this ArrayBrowserSidebar.
        :type: object
        """
