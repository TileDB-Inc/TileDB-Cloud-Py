...
class GroupSharing(object):
    ...
    def group_actions(self):
        """Gets the group_actions of this GroupSharing.

        List of permitted actions for the group and all subgroups

        :return: The group_actions of this GroupSharing.
    ...
    def group_actions(self, group_actions):
        ...
        :param group_actions: The group_actions of this GroupSharing.
    ...
    def array_actions(self):
        """Gets the array_actions of this GroupSharing.

        List of permitted actions for all the subarrays of the group

        :return: The array_actions of this GroupSharing.
    ...
    def array_actions(self, array_actions):
        ...
        :param array_actions: The array_actions of this GroupSharing.
    ...
    @property
    def namespace(self):
        """Gets the namespace of this GroupSharing.

        namespace being granted group access can be a user or organization

        :return: The namespace of this GroupSharing.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        ...
        :param namespace: The namespace of this GroupSharing.
        :type: str
        """
    ...
    def namespace_type(self):
        """Gets the namespace_type of this GroupSharing.

        details on if the namespace is a organization or user

        :return: The namespace_type of this GroupSharing.
        :rtype: str
        """
    ...
    def namespace_type(self, namespace_type):
        ...
        :param namespace_type: The namespace_type of this GroupSharing.
        :type: str
        """
