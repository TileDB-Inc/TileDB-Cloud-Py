...
class ArraySharing(object):
    ...
    def __init__(
        ...
        """ArraySharing - a model defined in OpenAPI"""
    ...
    @property
    def actions(self):
        """Gets the actions of this ArraySharing.

        List of permitted actions

        :return: The actions of this ArraySharing.
    ...
    def actions(self, actions):
        ...
        :param actions: The actions of this ArraySharing.
    ...
    @property
    def namespace(self):
        """Gets the namespace of this ArraySharing.

        namespace being granted array access can be a user or organization

        :return: The namespace of this ArraySharing.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        ...
        :param namespace: The namespace of this ArraySharing.
        :type: str
        """
    ...
    def namespace_type(self):
        """Gets the namespace_type of this ArraySharing.

        details on if the namespace is a organization or user

        :return: The namespace_type of this ArraySharing.
        :rtype: str
        """
    ...
    def namespace_type(self, namespace_type):
        ...
        :param namespace_type: The namespace_type of this ArraySharing.
        :type: str
        """
