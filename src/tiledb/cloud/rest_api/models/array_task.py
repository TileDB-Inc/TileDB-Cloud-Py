...
class ArrayTask(object):
    ...
    @property
    def id(self):
        """Gets the id of this ArrayTask.

        task ID

        :return: The id of this ArrayTask.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this ArrayTask.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ArrayTask.

        Optional task name

        :return: The name of this ArrayTask.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this ArrayTask.
        :type: str
        """
    ...
    @property
    def username(self):
        """Gets the username of this ArrayTask.

        username that executed this task

        :return: The username of this ArrayTask.
        :rtype: str
        """
    ...
    def username(self, username):
        ...
        :param username: The username of this ArrayTask.
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this ArrayTask.

        Optional task description (Tasks purpose)

        :return: The description of this ArrayTask.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        :param description: The description of this ArrayTask.
        :type: str
        """
    ...
    def array_metadata(self):
        """Gets the array_metadata of this ArrayTask.


        :return: The array_metadata of this ArrayTask.
        :rtype: ArrayInfo
        """
    ...
    def array_metadata(self, array_metadata):
        ...
        :param array_metadata: The array_metadata of this ArrayTask.
        :type: ArrayInfo
        """
    ...
    @property
    def subarray(self):
        """Gets the subarray of this ArrayTask.


        :return: The subarray of this ArrayTask.
        :rtype: DomainArray
        """
    ...
    def subarray(self, subarray):
        ...
        :param subarray: The subarray of this ArrayTask.
        :type: DomainArray
        """
    ...
    @property
    def memory(self):
        """Gets the memory of this ArrayTask.

        memory allocated to task in bytes

        :return: The memory of this ArrayTask.
        :rtype: int
        """
        return self._memory
    ...
    def memory(self, memory):
        ...
        :param memory: The memory of this ArrayTask.
        :type: int
        """
    ...
    @property
    def cpu(self):
        """Gets the cpu of this ArrayTask.

        millicpu allocated to task

        :return: The cpu of this ArrayTask.
        :rtype: int
        """
        return self._cpu
    ...
    def cpu(self, cpu):
        ...
        :param cpu: The cpu of this ArrayTask.
        :type: int
        """
    ...
    @property
    def namespace(self):
        """Gets the namespace of this ArrayTask.

        namespace task is tied to

        :return: The namespace of this ArrayTask.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        ...
        :param namespace: The namespace of this ArrayTask.
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this ArrayTask.


        :return: The status of this ArrayTask.
    ...
    def status(self, status):
        ...
        :param status: The status of this ArrayTask.
    ...
    def status_message(self):
        """Gets the status_message of this ArrayTask.

        The reason the array task status is in the state

        :return: The status_message of this ArrayTask.
        :rtype: str
        """
    ...
    def status_message(self, status_message):
        ...
        :param status_message: The status_message of this ArrayTask.
        :type: str
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this ArrayTask.

        Start time RFC3339 for job

        :return: The start_time of this ArrayTask.
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        ...
        :param start_time: The start_time of this ArrayTask.
        :type: datetime
        """
    ...
    def finish_time(self):
        """Gets the finish_time of this ArrayTask.

        Finish time RFC3339 for job

        :return: The finish_time of this ArrayTask.
        :rtype: datetime
        """
    ...
    def finish_time(self, finish_time):
        ...
        :param finish_time: The finish_time of this ArrayTask.
        :type: datetime
        """
    ...
    @property
    def cost(self):
        """Gets the cost of this ArrayTask.

        Total accumulated for task in USD, example is $0.12

        :return: The cost of this ArrayTask.
        :rtype: float
        """
        return self._cost
    ...
    def cost(self, cost):
        ...
        :param cost: The cost of this ArrayTask.
        :type: float
        """
    ...
    def egress_cost(self):
        """Gets the egress_cost of this ArrayTask.

        Total accumulated for egress task in USD, example is $0.12

        :return: The egress_cost of this ArrayTask.
        :rtype: float
        """
    ...
    def egress_cost(self, egress_cost):
        ...
        :param egress_cost: The egress_cost of this ArrayTask.
        :type: float
        """
    ...
    def access_cost(self):
        """Gets the access_cost of this ArrayTask.

        Cost accumulated for access task in USD, example is $0.12

        :return: The access_cost of this ArrayTask.
        :rtype: float
        """
    ...
    def access_cost(self, access_cost):
        ...
        :param access_cost: The access_cost of this ArrayTask.
        :type: float
        """
    ...
    @property
    def query_type(self):
        """Gets the query_type of this ArrayTask.


        :return: The query_type of this ArrayTask.
        :rtype: Querytype
        """
    ...
    def query_type(self, query_type):
        ...
        :param query_type: The query_type of this ArrayTask.
        :type: Querytype
        """
    ...
    @property
    def udf_code(self):
        """Gets the udf_code of this ArrayTask.

        Optional actual code that is going to be executed

        :return: The udf_code of this ArrayTask.
        :rtype: str
        """
    ...
    def udf_code(self, udf_code):
        ...
        :param udf_code: The udf_code of this ArrayTask.
        :type: str
        """
    ...
    def udf_language(self):
        """Gets the udf_language of this ArrayTask.

        Optional actual language used to express udf_code

        :return: The udf_language of this ArrayTask.
        :rtype: str
        """
    ...
    def udf_language(self, udf_language):
        ...
        :param udf_language: The udf_language of this ArrayTask.
        :type: str
        """
    ...
    @property
    def sql_query(self):
        """Gets the sql_query of this ArrayTask.

        Optional actual sql query that is going to be executed

        :return: The sql_query of this ArrayTask.
        :rtype: str
        """
    ...
    def sql_query(self, sql_query):
        ...
        :param sql_query: The sql_query of this ArrayTask.
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this ArrayTask.


        :return: The type of this ArrayTask.
        :rtype: ArrayTaskType
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this ArrayTask.
        :type: ArrayTaskType
        """
    ...
    @property
    def activity(self):
        """Gets the activity of this ArrayTask.

        Array activity logs for task

        :return: The activity of this ArrayTask.
    ...
    def activity(self, activity):
        ...
        :param activity: The activity of this ArrayTask.
    ...
    @property
    def logs(self):
        """Gets the logs of this ArrayTask.

        logs from array task

        :return: The logs of this ArrayTask.
        :rtype: str
        """
        return self._logs
    ...
    def logs(self, logs):
        ...
        :param logs: The logs of this ArrayTask.
        :type: str
        """
    ...
    @property
    def duration(self):
        """Gets the duration of this ArrayTask.

        duration in nanoseconds of an array task

        :return: The duration of this ArrayTask.
        :rtype: float
        """
    ...
    def duration(self, duration):
        ...
        :param duration: The duration of this ArrayTask.
        :type: float
        """
    ...
    def sql_init_commands(self):
        """Gets the sql_init_commands of this ArrayTask.

        SQL queries or commands to run before main sql query

        :return: The sql_init_commands of this ArrayTask.
        :rtype: list[str]
        """
    ...
    def sql_init_commands(self, sql_init_commands):
        ...
        :param sql_init_commands: The sql_init_commands of this ArrayTask.
        :type: list[str]
        """
    ...
    def sql_parameters(self):
        """Gets the sql_parameters of this ArrayTask.

        SQL query parameters

        :return: The sql_parameters of this ArrayTask.
        :rtype: list[object]
        """
    ...
    def sql_parameters(self, sql_parameters):
        ...
        :param sql_parameters: The sql_parameters of this ArrayTask.
        :type: list[object]
        """
    ...
    def result_format(self):
        """Gets the result_format of this ArrayTask.


        :return: The result_format of this ArrayTask.
        :rtype: ResultFormat
        """
    ...
    def result_format(self, result_format):
        ...
        :param result_format: The result_format of this ArrayTask.
        :type: ResultFormat
        """
    ...
    def task_graph_uuid(self):
        """Gets the task_graph_uuid of this ArrayTask.

        If set, the ID of the log for the task graph that this was part of.

        :return: The task_graph_uuid of this ArrayTask.
        :rtype: str
        """
    ...
    def task_graph_uuid(self, task_graph_uuid):
        ...
        :param task_graph_uuid: The task_graph_uuid of this ArrayTask.
        :type: str
        """
    ...
    def client_node_uuid(self):
        """Gets the client_node_uuid of this ArrayTask.

        If set, the client-defined ID of the node within this task's graph.

        :return: The client_node_uuid of this ArrayTask.
        :rtype: str
        """
    ...
    def client_node_uuid(self, client_node_uuid):
        ...
        :param client_node_uuid: The client_node_uuid of this ArrayTask.
        :type: str
        """
