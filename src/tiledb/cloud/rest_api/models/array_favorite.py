...
class ArrayFavorite:
    ...
    def __init__(
        ...
        """ArrayFavorite - a model defined in OpenAPI"""
    ...
    @property
    def array_uuid(self):
        """Gets the array_uuid of this ArrayFavorite.

        unique UUID of the array

        :return: The array_uuid of this ArrayFavorite.
        :rtype: str
        """
    ...
    def array_uuid(self, array_uuid):
        ...
        :param array_uuid: The array_uuid of this ArrayFavorite.
        :type: str
        """
    ...
    @property
    def namespace(self):
        """Gets the namespace of this ArrayFavorite.

        the namespace of the array

        :return: The namespace of this ArrayFavorite.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        ...
        :param namespace: The namespace of this ArrayFavorite.
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ArrayFavorite.

        the name of the array

        :return: The name of this ArrayFavorite.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this ArrayFavorite.
        :type: str
        """
