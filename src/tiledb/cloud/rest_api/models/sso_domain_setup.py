...
class SSODomainSetup:
    ...
    def __init__(
        ...
        """SSODomainSetup - a model defined in OpenAPI"""
    ...
    @property
    def txt(self):
        """Gets the txt of this SSODomainSetup.

        a DNS TXT record to set on the domain to claim.

        :return: The txt of this SSODomainSetup.
        :rtype: str
        """
        return self._txt
    ...
    def txt(self, txt):
        ...
        :param txt: The txt of this SSODomainSetup.
        :type: str
        """
    ...
    @property
    def cname_src(self):
        """Gets the cname_src of this SSODomainSetup.

        a DNS name to set a CNAME record on

        :return: The cname_src of this SSODomainSetup.
        :rtype: str
        """
    ...
    def cname_src(self, cname_src):
        ...
        :param cname_src: The cname_src of this SSODomainSetup.
        :type: str
        """
    ...
    @property
    def cname_dst(self):
        """Gets the cname_dst of this SSODomainSetup.

        the CNAME target of `cname_src`.

        :return: The cname_dst of this SSODomainSetup.
        :rtype: str
        """
    ...
    def cname_dst(self, cname_dst):
        ...
        :param cname_dst: The cname_dst of this SSODomainSetup.
        :type: str
        """
