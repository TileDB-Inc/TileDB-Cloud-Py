# tiledb.cloud.\_common.api_v4.ImagesApi

All URIs are relative to *https://api.tiledb.com/v4*

| Method                                  | HTTP request                      | Description               |
| --------------------------------------- | --------------------------------- | ------------------------- |
| [**get_image**](ImagesApi.md#get_image) | **GET** /static/images/{image_id} | Retrieves the given image |

# **get_image**

> file get_image(image_id)
...
with tiledb.cloud._common.api_v4.ApiClient(configuration) as api_client:
    ...
    api_instance = tiledb.cloud._common.api_v4.ImagesApi(api_client)
    image_id = 'image_id_example' # str | The image id in the form img_9m4e2mr0ui3e8a215n4g
...
| ------------ | ------- | ------------------------------------------------- | ----- |
| **image_id** | **str** | The image id in the form img_9m4e2mr0ui3e8a215n4g |
