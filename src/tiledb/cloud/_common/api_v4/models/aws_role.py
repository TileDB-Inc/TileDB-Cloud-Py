...
class AWSRole(object):
    ...
    def role_arn(self, role_arn):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and role_arn is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `role_arn`, must not be `None`"
            )  # noqa: E501
    ...
    def external_id(self, external_id):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and external_id is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `external_id`, must not be `None`"
            )  # noqa: E501
