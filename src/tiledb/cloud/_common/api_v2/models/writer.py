...
class Writer(object):
    ...
    attribute_map = {
        ...
        "subarray_ranges": "subarrayRanges",
        "subarray": "subarray",
    }
    ...
    def __init__(
        ...
        if subarray_ranges is not None:
            self.subarray_ranges = subarray_ranges
        if subarray is not None:
            self.subarray = subarray

    @property
    def check_coord_dups(self):
        """Gets the check_coord_dups of this Writer.


        :return: The check_coord_dups of this Writer.
        :rtype: bool
        """
    ...
    def check_coord_dups(self, check_coord_dups):
        ...
        :param check_coord_dups: The check_coord_dups of this Writer.
        :type: bool
        """
    ...
    def check_coord_oob(self):
        """Gets the check_coord_oob of this Writer.


        :return: The check_coord_oob of this Writer.
        :rtype: bool
        """
    ...
    def check_coord_oob(self, check_coord_oob):
        ...
        :param check_coord_oob: The check_coord_oob of this Writer.
        :type: bool
        """
    ...
    def dedup_coords(self):
        """Gets the dedup_coords of this Writer.


        :return: The dedup_coords of this Writer.
        :rtype: bool
        """
    ...
    def dedup_coords(self, dedup_coords):
        ...
        :param dedup_coords: The dedup_coords of this Writer.
        :type: bool
        """
    ...
    @property
    def subarray_ranges(self):
        """Gets the subarray_ranges of this Writer.


        :return: The subarray_ranges of this Writer.
        :rtype: Subarray
        """
        return self._subarray_ranges

    @subarray_ranges.setter
    def subarray_ranges(self, subarray_ranges):
        """Sets the subarray_ranges of this Writer.


        :param subarray_ranges: The subarray_ranges of this Writer.
        :type: Subarray
        """

        self._subarray_ranges = subarray_ranges

    @property
    def subarray(self):
        """Gets the subarray of this Writer.


        :return: The subarray of this Writer.
        :rtype: DomainArray
        """
    ...
    def subarray(self, subarray):
        ...
        :param subarray: The subarray of this Writer.
        :type: DomainArray
        """
