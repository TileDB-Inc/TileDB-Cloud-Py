...
class ReadState(object):
    ...
    def initialized(self):
        """Gets the initialized of this ReadState.

        True if the reader has been initialized.

        :return: The initialized of this ReadState.
        :rtype: bool
        """
    ...
    def initialized(self, initialized):
        ...
        :param initialized: The initialized of this ReadState.
        :type: bool
        """
    ...
    @property
    def overflowed(self):
        """Gets the overflowed of this ReadState.

        True if the query produced results that could not fit in some buffer.

        :return: The overflowed of this ReadState.
        :rtype: bool
        """
    ...
    def overflowed(self, overflowed):
        ...
        :param overflowed: The overflowed of this ReadState.
        :type: bool
        """
    ...
    def unsplittable(self):
        """Gets the unsplittable of this ReadState.

        True if the current subarray partition is unsplittable.

        :return: The unsplittable of this ReadState.
        :rtype: bool
        """
    ...
    def unsplittable(self, unsplittable):
        ...
        :param unsplittable: The unsplittable of this ReadState.
        :type: bool
        """
    ...
    def subarray_partitioner(self):
        """Gets the subarray_partitioner of this ReadState.


        :return: The subarray_partitioner of this ReadState.
    ...
    def subarray_partitioner(self, subarray_partitioner):
        ...
        :param subarray_partitioner: The subarray_partitioner of this ReadState.
