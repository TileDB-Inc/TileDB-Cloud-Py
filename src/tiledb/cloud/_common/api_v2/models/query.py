...
class Query(object):
    ...
    openapi_types = {
        ...
        "total_validity_buffer_bytes": "int",
    }
    ...
    attribute_map = {
        ...
        "total_validity_buffer_bytes": "totalValidityBufferBytes",
    }
    ...
    def __init__(
        ...
        total_validity_buffer_bytes=None,
        ...
        self._total_validity_buffer_bytes = None
        ...
        if total_validity_buffer_bytes is not None:
            self.total_validity_buffer_bytes = total_validity_buffer_bytes
    ...
    @property
    def layout(self):
        """Gets the layout of this Query.


        :return: The layout of this Query.
        :rtype: Layout
        """
        return self._layout
    ...
    def layout(self, layout):
        ...
        :param layout: The layout of this Query.
        :type: Layout
        """
        if self.local_vars_configuration.client_side_validation and layout is None:
    ...
    def attribute_buffer_headers(self):
        """Gets the attribute_buffer_headers of this Query.

        List of attribute buffer headers

        :return: The attribute_buffer_headers of this Query.
    ...
    def attribute_buffer_headers(self, attribute_buffer_headers):
        ...
        :param attribute_buffer_headers: The attribute_buffer_headers of this Query.
    ...
    @property
    def writer(self):
        """Gets the writer of this Query.


        :return: The writer of this Query.
        :rtype: Writer
        """
        return self._writer
    ...
    def writer(self, writer):
        ...
        :param writer: The writer of this Query.
        :type: Writer
        """
    ...
    @property
    def reader(self):
        """Gets the reader of this Query.


        :return: The reader of this Query.
        :rtype: QueryReader
        """
        return self._reader
    ...
    def reader(self, reader):
        ...
        :param reader: The reader of this Query.
        :type: QueryReader
        """
    ...
    @property
    def array(self):
        """Gets the array of this Query.


        :return: The array of this Query.
        :rtype: Array
        """
        return self._array
    ...
    def array(self, array):
        ...
        :param array: The array of this Query.
        :type: Array
        """
        if self.local_vars_configuration.client_side_validation and array is None:
    ...
    def total_fixed_length_buffer_bytes(self):
        """Gets the total_fixed_length_buffer_bytes of this Query.

        Total number of bytes in fixed size attribute buffers.

        :return: The total_fixed_length_buffer_bytes of this Query.
        :rtype: int
        """
    ...
    def total_fixed_length_buffer_bytes(self, total_fixed_length_buffer_bytes):
        ...
        :param total_fixed_length_buffer_bytes: The total_fixed_length_buffer_bytes of this Query.
        :type: int
        """
        if (
            self.local_vars_configuration.client_side_validation
    ...
    def total_var_len_buffer_bytes(self):
        """Gets the total_var_len_buffer_bytes of this Query.

        Total number of bytes in variable size attribute buffers.

        :return: The total_var_len_buffer_bytes of this Query.
        :rtype: int
        """
    ...
    def total_var_len_buffer_bytes(self, total_var_len_buffer_bytes):
        ...
        :param total_var_len_buffer_bytes: The total_var_len_buffer_bytes of this Query.
        :type: int
        """
        if (
            self.local_vars_configuration.client_side_validation
    ...
    @property
    def total_validity_buffer_bytes(self):
        """Gets the total_validity_buffer_bytes of this Query.

        Total number of bytes in validity buffers

        :return: The total_validity_buffer_bytes of this Query.
        :rtype: int
        """
        return self._total_validity_buffer_bytes

    @total_validity_buffer_bytes.setter
    def total_validity_buffer_bytes(self, total_validity_buffer_bytes):
        """Sets the total_validity_buffer_bytes of this Query.

        Total number of bytes in validity buffers

        :param total_validity_buffer_bytes: The total_validity_buffer_bytes of this Query.
        :type: int
        """

        self._total_validity_buffer_bytes = total_validity_buffer_bytes
