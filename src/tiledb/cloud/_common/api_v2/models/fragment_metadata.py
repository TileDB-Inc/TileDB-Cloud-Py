...
class FragmentMetadata(object):
    ...
    def __init__(
        ...
        """FragmentMetadata - a model defined in OpenAPI"""
    ...
    @property
    def file_sizes(self):
        """Gets the file_sizes of this FragmentMetadata.

        The size of each attribute file

        :return: The file_sizes of this FragmentMetadata.
        :rtype: list[float]
        """
    ...
    def file_sizes(self, file_sizes):
        ...
        :param file_sizes: The file_sizes of this FragmentMetadata.
        :type: list[float]
        """
    ...
    def file_var_sizes(self):
        """Gets the file_var_sizes of this FragmentMetadata.

        The size of each var attribute file

        :return: The file_var_sizes of this FragmentMetadata.
        :rtype: list[float]
        """
    ...
    def file_var_sizes(self, file_var_sizes):
        ...
        :param file_var_sizes: The file_var_sizes of this FragmentMetadata.
        :type: list[float]
        """
    ...
    def file_validity_sizes(self):
        """Gets the file_validity_sizes of this FragmentMetadata.

        The size of each validity attribute file

        :return: The file_validity_sizes of this FragmentMetadata.
        :rtype: list[float]
        """
    ...
    def file_validity_sizes(self, file_validity_sizes):
        ...
        :param file_validity_sizes: The file_validity_sizes of this FragmentMetadata.
        :type: list[float]
        """
    ...
    def fragment_uri(self):
        """Gets the fragment_uri of this FragmentMetadata.

        The uri of the fragment this metadata belongs to

        :return: The fragment_uri of this FragmentMetadata.
        :rtype: str
        """
    ...
    def fragment_uri(self, fragment_uri):
        ...
        :param fragment_uri: The fragment_uri of this FragmentMetadata.
        :type: str
        """
    ...
    def has_timestamps(self):
        """Gets the has_timestamps of this FragmentMetadata.

        True if the fragment has timestamps

        :return: The has_timestamps of this FragmentMetadata.
        :rtype: bool
        """
    ...
    def has_timestamps(self, has_timestamps):
        ...
        :param has_timestamps: The has_timestamps of this FragmentMetadata.
        :type: bool
        """
    ...
    def has_delete_meta(self):
        """Gets the has_delete_meta of this FragmentMetadata.

        True if the fragment has delete metadata

        :return: The has_delete_meta of this FragmentMetadata.
        :rtype: bool
        """
    ...
    def has_delete_meta(self, has_delete_meta):
        ...
        :param has_delete_meta: The has_delete_meta of this FragmentMetadata.
        :type: bool
        """
    ...
    def sparse_tile_num(self):
        """Gets the sparse_tile_num of this FragmentMetadata.

        The number of sparse tiles

        :return: The sparse_tile_num of this FragmentMetadata.
        :rtype: float
        """
    ...
    def sparse_tile_num(self, sparse_tile_num):
        ...
        :param sparse_tile_num: The sparse_tile_num of this FragmentMetadata.
        :type: float
        """
    ...
    def tile_index_base(self):
        """Gets the tile_index_base of this FragmentMetadata.

        Used to track the tile index base between global order writes

        :return: The tile_index_base of this FragmentMetadata.
        :rtype: float
        """
    ...
    def tile_index_base(self, tile_index_base):
        ...
        :param tile_index_base: The tile_index_base of this FragmentMetadata.
        :type: float
        """
    ...
    def tile_offsets(self):
        """Gets the tile_offsets of this FragmentMetadata.

        Tile offsets in their attribute files

        :return: The tile_offsets of this FragmentMetadata.
    ...
    def tile_offsets(self, tile_offsets):
        ...
        :param tile_offsets: The tile_offsets of this FragmentMetadata.
    ...
    def tile_var_offsets(self):
        """Gets the tile_var_offsets of this FragmentMetadata.

        Variable tile offsets in their attribute files

        :return: The tile_var_offsets of this FragmentMetadata.
        :rtype: list[list[float]]
        """
    ...
    def tile_var_offsets(self, tile_var_offsets):
        ...
        :param tile_var_offsets: The tile_var_offsets of this FragmentMetadata.
        :type: list[list[float]]
        """
    ...
    def tile_var_sizes(self):
        """Gets the tile_var_sizes of this FragmentMetadata.

        The sizes of the uncompressed variable tiles

        :return: The tile_var_sizes of this FragmentMetadata.
        :rtype: list[list[float]]
        """
    ...
    def tile_var_sizes(self, tile_var_sizes):
        ...
        :param tile_var_sizes: The tile_var_sizes of this FragmentMetadata.
        :type: list[list[float]]
        """
    ...
    def tile_validity_offsets(self):
        """Gets the tile_validity_offsets of this FragmentMetadata.

        Validity tile offests in their attribute files

        :return: The tile_validity_offsets of this FragmentMetadata.
        :rtype: list[list[float]]
        """
    ...
    def tile_validity_offsets(self, tile_validity_offsets):
        ...
        :param tile_validity_offsets: The tile_validity_offsets of this FragmentMetadata.
        :type: list[list[float]]
        """
    ...
    def tile_min_buffer(self):
        """Gets the tile_min_buffer of this FragmentMetadata.

        tile min buffers

        :return: The tile_min_buffer of this FragmentMetadata.
        :rtype: list[list[float]]
        """
    ...
    def tile_min_buffer(self, tile_min_buffer):
        ...
        :param tile_min_buffer: The tile_min_buffer of this FragmentMetadata.
        :type: list[list[float]]
        """
    ...
    def tile_min_var_buffer(self):
        """Gets the tile_min_var_buffer of this FragmentMetadata.

        tile min buffers for var length data

        :return: The tile_min_var_buffer of this FragmentMetadata.
        :rtype: list[list[float]]
        """
    ...
    def tile_min_var_buffer(self, tile_min_var_buffer):
        ...
        :param tile_min_var_buffer: The tile_min_var_buffer of this FragmentMetadata.
        :type: list[list[float]]
        """
    ...
    def tile_max_buffer(self):
        """Gets the tile_max_buffer of this FragmentMetadata.

        tile max buffers

        :return: The tile_max_buffer of this FragmentMetadata.
        :rtype: list[list[float]]
        """
    ...
    def tile_max_buffer(self, tile_max_buffer):
        ...
        :param tile_max_buffer: The tile_max_buffer of this FragmentMetadata.
        :type: list[list[float]]
        """
    ...
    def tile_max_var_buffer(self):
        """Gets the tile_max_var_buffer of this FragmentMetadata.

        tile max buffers for var length data

        :return: The tile_max_var_buffer of this FragmentMetadata.
        :rtype: list[list[float]]
        """
    ...
    def tile_max_var_buffer(self, tile_max_var_buffer):
        ...
        :param tile_max_var_buffer: The tile_max_var_buffer of this FragmentMetadata.
        :type: list[list[float]]
        """
    ...
    @property
    def tile_sums(self):
        """Gets the tile_sums of this FragmentMetadata.

        tile sum values

        :return: The tile_sums of this FragmentMetadata.
        :rtype: list[list[float]]
        """
    ...
    def tile_sums(self, tile_sums):
        ...
        :param tile_sums: The tile_sums of this FragmentMetadata.
        :type: list[list[float]]
        """
    ...
    def tile_null_counts(self):
        """Gets the tile_null_counts of this FragmentMetadata.

        tile null count values

        :return: The tile_null_counts of this FragmentMetadata.
        :rtype: list[list[float]]
        """
    ...
    def tile_null_counts(self, tile_null_counts):
        ...
        :param tile_null_counts: The tile_null_counts of this FragmentMetadata.
        :type: list[list[float]]
        """
    ...
    def fragment_mins(self):
        """Gets the fragment_mins of this FragmentMetadata.

        fragment min values

        :return: The fragment_mins of this FragmentMetadata.
        :rtype: list[list[float]]
        """
    ...
    def fragment_mins(self, fragment_mins):
        ...
        :param fragment_mins: The fragment_mins of this FragmentMetadata.
        :type: list[list[float]]
        """
    ...
    def fragment_maxs(self):
        """Gets the fragment_maxs of this FragmentMetadata.

        fragment max values

        :return: The fragment_maxs of this FragmentMetadata.
        :rtype: list[list[float]]
        """
    ...
    def fragment_maxs(self, fragment_maxs):
        ...
        :param fragment_maxs: The fragment_maxs of this FragmentMetadata.
        :type: list[list[float]]
        """
    ...
    def fragment_sums(self):
        """Gets the fragment_sums of this FragmentMetadata.

        fragment sum values

        :return: The fragment_sums of this FragmentMetadata.
        :rtype: list[float]
        """
    ...
    def fragment_sums(self, fragment_sums):
        ...
        :param fragment_sums: The fragment_sums of this FragmentMetadata.
        :type: list[float]
        """
    ...
    def fragment_null_counts(self):
        """Gets the fragment_null_counts of this FragmentMetadata.

        fragment null count values

        :return: The fragment_null_counts of this FragmentMetadata.
        :rtype: list[float]
        """
    ...
    def fragment_null_counts(self, fragment_null_counts):
        ...
        :param fragment_null_counts: The fragment_null_counts of this FragmentMetadata.
        :type: list[float]
        """
    ...
    @property
    def version(self):
        """Gets the version of this FragmentMetadata.

        the format version of this metadata

        :return: The version of this FragmentMetadata.
        :rtype: int
        """
    ...
    def version(self, version):
        ...
        :param version: The version of this FragmentMetadata.
        :type: int
        """
    ...
    def timestamp_range(self):
        """Gets the timestamp_range of this FragmentMetadata.

        A pair of timestamps for fragment

        :return: The timestamp_range of this FragmentMetadata.
        :rtype: list[float]
        """
    ...
    def timestamp_range(self, timestamp_range):
        ...
        :param timestamp_range: The timestamp_range of this FragmentMetadata.
        :type: list[float]
        """
    ...
    def last_tile_cell_num(self):
        """Gets the last_tile_cell_num of this FragmentMetadata.

        The number of cells in the last tile

        :return: The last_tile_cell_num of this FragmentMetadata.
        :rtype: int
        """
    ...
    def last_tile_cell_num(self, last_tile_cell_num):
        ...
        :param last_tile_cell_num: The last_tile_cell_num of this FragmentMetadata.
        :type: int
        """
    ...
    def non_empty_domain(self):
        """Gets the non_empty_domain of this FragmentMetadata.


        :return: The non_empty_domain of this FragmentMetadata.
    ...
    def non_empty_domain(self, non_empty_domain):
        ...
        :param non_empty_domain: The non_empty_domain of this FragmentMetadata.
    ...
    @property
    def rtree(self):
        """Gets the rtree of this FragmentMetadata.

        The RTree for the MBRs serialized as a blob

        :return: The rtree of this FragmentMetadata.
        :rtype: file
        """
        return self._rtree
    ...
    def rtree(self, rtree):
        ...
        :param rtree: The rtree of this FragmentMetadata.
        :type: file
        """
    ...
    def has_consolidated_footer(self):
        """Gets the has_consolidated_footer of this FragmentMetadata.

        if the fragment metadata footer appears in a consolidated file

        :return: The has_consolidated_footer of this FragmentMetadata.
        :rtype: bool
        """
    ...
    def has_consolidated_footer(self, has_consolidated_footer):
        ...
        :param has_consolidated_footer: The has_consolidated_footer of this FragmentMetadata.
        :type: bool
        """
    ...
    @property
    def gt_offsets(self):
        """Gets the gt_offsets of this FragmentMetadata.


        :return: The gt_offsets of this FragmentMetadata.
    ...
    def gt_offsets(self, gt_offsets):
        ...
        :param gt_offsets: The gt_offsets of this FragmentMetadata.
