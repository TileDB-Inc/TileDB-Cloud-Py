...
from tiledb.cloud._common.api_v2.models.filter_type import FilterType  # noqa: E501
...
class TestFilterType(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tiledb.cloud._common.api_v2.models.filter_type.FilterType()  # noqa: E501
        if include_optional:
            return FilterType()
        else:
            return FilterType()
