...
This will create generated API documents in [repo root]/tiledb/cloud/rest_api_v2.
'
...
sed --in-place -e "s/](rest_api_v2\\//](/g" "${TEMP_PATH}/${TEMP_PACKAGE_NAME}_README.md"
...
git apply - <<EOF
diff --git a/tiledb/cloud/rest_api_v2/api_client.py b/tiledb/cloud/rest_api_v2/api_client.py
index 267385d..6d244a0 100644
--- a/tiledb/cloud/rest_api_v2/api_client.py
+++ b/tiledb/cloud/rest_api_v2/api_client.py
@@ -25,6 +25,7 @@ from dateutil.parser import parse
 from six.moves.urllib.parse import quote
 
 import tiledb.cloud.rest_api_v2.models
+from tiledb.cloud._common import json_safe
 from tiledb.cloud.rest_api_v2 import rest
 from tiledb.cloud.rest_api_v2.configuration import Configuration
 from tiledb.cloud.rest_api_v2.exceptions import ApiException
