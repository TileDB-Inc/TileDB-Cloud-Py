...
from tiledb.cloud._common.api_v2.models.querystatus import Querystatus  # noqa: E501
...
class TestQuerystatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tiledb.cloud._common.api_v2.models.querystatus.Querystatus()  # noqa: E501
        if include_optional:
            return Querystatus()
        else:
            return Querystatus()
