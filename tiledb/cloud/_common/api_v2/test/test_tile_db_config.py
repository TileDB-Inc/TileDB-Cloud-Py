...
from tiledb.cloud._common.api_v2.models.tile_db_config import TileDBConfig  # noqa: E501
...
class TestTileDBConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tiledb.cloud._common.api_v2.models.tile_db_config.TileDBConfig()  # noqa: E501
        if include_optional:
            return TileDBConfig(
                entries=[
