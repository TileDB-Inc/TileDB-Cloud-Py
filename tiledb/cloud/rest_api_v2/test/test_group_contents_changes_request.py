...
class TestGroupContentsChangesRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tiledb.cloud.rest_api.models.group_contents_changes_request.GroupContentsChangesRequest()  # noqa: E501
        if include_optional:
            return GroupContentsChangesRequest(
                ...
                group_changes=tiledb.cloud.rest_api.models.group_contents_changes_request_group_changes.GroupContentsChangesRequest_group_changes(
                    members_to_remove=["0"],
                    members_to_add=[
