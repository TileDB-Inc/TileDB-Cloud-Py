...
class ArrayActivityLog(object):
    ...
    def __init__(self, event_at=None, action=None, username=None, bytes_sent=None, bytes_received=None, array_task_id=None, id=None, query_ranges=None, query_stats=None, local_vars_configuration=None):  # noqa: E501
