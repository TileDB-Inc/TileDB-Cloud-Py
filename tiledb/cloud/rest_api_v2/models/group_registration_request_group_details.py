...
class GroupRegistrationRequestGroupDetails(object):
    ...
    def __init__(self, description=None, name=None, parent=None, uri=None, logo=None, tags=None, license_id=None, license_text=None, region=None, access_credentials_name=None, local_vars_configuration=None):  # noqa: E501
