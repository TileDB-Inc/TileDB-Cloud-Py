...
class ActivityEventType(object):
    ...
    allowable_values = [READ_SCHEMA, MAX_BUFFER_SIZES, NON_EMPTY_DOMAIN, QUERY_READ, QUERY_WRITE, CREATE, DELETE, REGISTER, DEREGISTER, UDF, ARRAY_METADATA_GET, ARRAY_METADATA_UPDATE, ESTIMATED_RESULT_SIZES, UPDATE, INFO, RUN]  # noqa: E501
