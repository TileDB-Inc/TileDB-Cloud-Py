...
class FilesApi(object):
    ...
    def handle_upload_file(self, namespace, array, content_type, filesize, file, **kwargs):  # noqa: E501
        ...
        return self.handle_upload_file_with_http_info(namespace, array, content_type, filesize, file, **kwargs)  # noqa: E501

    def handle_upload_file_with_http_info(self, namespace, array, content_type, filesize, file, **kwargs):  # noqa: E501
        """handle_upload_file  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('namespace' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `namespace` when calling `handle_upload_file`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('array' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `array` when calling `handle_upload_file`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('content_type' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `content_type` when calling `handle_upload_file`")  # noqa: E501
        # verify the required parameter 'filesize' is set
        if self.api_client.client_side_validation and ('filesize' not in local_var_params or  # noqa: E501
                                                        local_var_params['filesize'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `filesize` when calling `handle_upload_file`")  # noqa: E501
        # verify the required parameter 'file' is set
        if self.api_client.client_side_validation and ('file' not in local_var_params or  # noqa: E501
                                                        local_var_params['file'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `file` when calling `handle_upload_file`")  # noqa: E501
        ...
        if 'filesize' in local_var_params and local_var_params['filesize'] is not None:  # noqa: E501
            query_params.append(('filesize', local_var_params['filesize']))  # noqa: E501
        if 'mimetype' in local_var_params and local_var_params['mimetype'] is not None:  # noqa: E501
            query_params.append(('mimetype', local_var_params['mimetype']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/files/{namespace}/{array}/upload', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
