...
class StatsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_tiledb_stats_endpoint = _Endpoint(
            settings={
                "response_type": (InlineResponse200,),
                "auth": ["ApiKeyAuth", "BasicAuth"],
                "endpoint_path": "/.stats",
                "operation_id": "get_tiledb_stats",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def get_tiledb_stats(self, **kwargs):
        ...
        return self.get_tiledb_stats_endpoint.call_with_http_info(**kwargs)
