...
from tiledb.cloud.rest_api.models.task_graph_logs_data import (  # noqa: E501
    TaskGraphLogsData,
)
from tiledb.cloud.rest_api.rest import ApiException


class TestTaskGraphLogsData(unittest.TestCase):
    """TaskGraphLogsData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test TaskGraphLogsData
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # model = tiledb.cloud.rest_api.models.task_graph_logs_data.TaskGraphLogsData()  # noqa: E501
        if include_optional:
            return TaskGraphLogsData(
                task_graph_logs=[
                    tiledb.cloud.rest_api.models.task_graph_log.TaskGraphLog(
                        uuid="0",
                        namespace="0",
                        created_by="0",
                        name="0",
    ...
    def testTaskGraphLogsData(self):
        """Test TaskGraphLogsData"""
