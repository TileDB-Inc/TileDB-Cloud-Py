...
from tiledb.cloud.rest_api.models.group_listing_all_of import (  # noqa: E501
    GroupListingAllOf,
)
from tiledb.cloud.rest_api.rest import ApiException


class TestGroupListingAllOf(unittest.TestCase):
    """GroupListingAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GroupListingAllOf
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # model = tiledb.cloud.rest_api.models.group_listing_all_of.GroupListingAllOf()  # noqa: E501
        if include_optional:
            return GroupListingAllOf(
                groups=[
                    tiledb.cloud.rest_api.models.group.Group(
                        id="0",
                        namespace="0",
                        name="0",
                        description="0",
    ...
    def testGroupListingAllOf(self):
        """Test GroupListingAllOf"""
