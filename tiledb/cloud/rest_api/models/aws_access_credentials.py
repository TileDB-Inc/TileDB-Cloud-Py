...
class AWSAccessCredentials(object):
    ...
    def __init__(self, secret_access_key=None, access_key_id=None, service_role_arn=None, name=None, default=None, buckets=None, created_at=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
