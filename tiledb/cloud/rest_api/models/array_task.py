...
class ArrayTask(object):
    ...
    def __init__(self, id=None, name=None, description=None, array_metadata=None, subarray=None, memory=None, cpu=None, namespace=None, status=None, start_time=None, finish_time=None, cost=None, query_type=None, udf_code=None, udf_language=None, sql_query=None, type=None, activity=None, logs=None, local_vars_configuration=None):  # noqa: E501
