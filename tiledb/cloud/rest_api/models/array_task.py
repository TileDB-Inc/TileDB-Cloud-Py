...
class ArrayTask(object):
    ...
    def __init__(self, id=None, name=None, description=None, array_metadata=None, subarray=None, memory=None, cpu=None, namespace=None, status=None, start_time=None, finish_time=None, cost=None, query_type=None, udf_code=None, udf_language=None, sql_query=None, type=None):  # noqa: E501
    ...
    def cost(self):
        ...
        Cost accumulated for task in 0.001 USD, example is 1 USD  # noqa: E501
