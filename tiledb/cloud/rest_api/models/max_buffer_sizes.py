...
class MaxBufferSizes(object):
    ...
    """
    openapi_types = {
        'max_buffer_sizes': 'list[AttributeBufferSize]'
    }

    attribute_map = {
        'max_buffer_sizes': 'maxBufferSizes'
    }

    def __init__(self, max_buffer_sizes=None, local_vars_configuration=None):  # noqa: E501
