...
class UDFInfo(object):
    ...
    def __init__(self, id=None, name=None, language=None, type=None, readme=None, license_id=None, license_text=None, tags=None, local_vars_configuration=None):  # noqa: E501
