...
class UDFImageVersion(object):
    ...
    def __init__(self, id=None, name=None, udf_image_uuid=None, docker_image=None, version=None, default=None, latest=None, local_vars_configuration=None):  # noqa: E501
