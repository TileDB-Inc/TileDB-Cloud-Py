...
class TGUDFEnvironment(ModelNormal):
    ...
    attribute_map = {
        ...
        "language_version": "language_version",  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            language_version (str): The language version used to execute this UDF. Neither this nor `language` needs to be set for registered UDFs, since the language and version are stored server-side with the UDF itself. . [optional]  # noqa: E501
            image_name (str): The name of the image to use for the execution environment. . [optional]  # noqa: E501
