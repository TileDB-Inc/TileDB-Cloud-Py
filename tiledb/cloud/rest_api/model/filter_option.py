...
class FilterOption(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """FilterOption - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): TileDB filter option., must be one of ["COMPRESSION_LEVEL", "BIT_WIDTH_MAX_WINDOW", "POSITIVE_DELTA_MAX_WINDOW", ]  # noqa: E501

        Keyword Args:
            value (str): TileDB filter option., must be one of ["COMPRESSION_LEVEL", "BIT_WIDTH_MAX_WINDOW", "POSITIVE_DELTA_MAX_WINDOW", ]  # noqa: E501
