...
class PricingAggregateUsage(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PricingAggregateUsage - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Specifies a usage aggregation strategy for pricings of usage_type=metered. if omitted defaults to "sum", must be one of ["sum", ]  # noqa: E501

        Keyword Args:
            value (str): Specifies a usage aggregation strategy for pricings of usage_type=metered. if omitted defaults to "sum", must be one of ["sum", ]  # noqa: E501
