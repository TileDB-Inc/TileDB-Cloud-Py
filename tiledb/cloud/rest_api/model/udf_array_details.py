...
class UDFArrayDetails(ModelNormal):
    ...
    attribute_map = {
        "parameter_id": "parameter_id",  # noqa: E501
        "uri": "uri",  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            parameter_id (str, none_type): An optional client-generated identifier to distinguish between multiple range/buffer requests from the same array in the same call. This may be set for MultiArrayUDFs that use the `argument_json` style of passing arrays. . [optional]  # noqa: E501
            uri (str): array to set ranges and buffers on, must be in tiledb:// format. [optional]  # noqa: E501
            ranges (QueryRanges): [optional]  # noqa: E501
            buffers ([str]): List of buffers to fetch (attributes + dimensions). [optional]  # noqa: E501
        """
