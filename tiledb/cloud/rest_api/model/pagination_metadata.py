...
class PaginationMetadata(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            page (float): pagination offset. Use it to skip the first ((page - 1) * per_page) items. [optional]  # noqa: E501
            per_page (float): pagination limit (page size). [optional]  # noqa: E501
            total_pages (float): number of total pages with current limit. [optional]  # noqa: E501
            total_items (float): number of total available items. [optional]  # noqa: E501
        """
