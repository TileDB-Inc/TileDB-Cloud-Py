...
class ResultFormat(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Data format of a result., must be one of ["python_pickle", "r_serialization", "json", "arrow", "bytes", "tiledb_json", "native", ]  # noqa: E501

        Keyword Args:
            value (str): Data format of a result., must be one of ["python_pickle", "r_serialization", "json", "arrow", "bytes", "tiledb_json", "native", ]  # noqa: E501
