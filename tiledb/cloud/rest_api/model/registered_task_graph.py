...
class RegisteredTaskGraph(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "tags": ([str],),  # noqa: E501
            "nodes": ([RegisteredTaskGraphNode],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            uuid (str): A server-assigned unique ID for the UDF, in UUID format.. [optional]  # noqa: E501
            namespace (str): The namespace that owns this task graph log.. [optional]  # noqa: E501
            name (str): The name of this graph, to appear in URLs. Must be unique per-namespace. . [optional]  # noqa: E501
            readme (str): Documentation for the task graph, in Markdown format.. [optional]  # noqa: E501
            license_id (str, none_type): SPDX license identifier.. [optional]  # noqa: E501
            license_text (str, none_type): Full text of the license.. [optional]  # noqa: E501
            tags ([str]): Optional tags to classify the graph.. [optional]  # noqa: E501
            nodes ([RegisteredTaskGraphNode]): The structure of the graph, in the form of the nodes that make it up. As with `TaskGraphLog`, nodes must topologically sorted, so that any node appears after all the nodes it depends on. . [optional]  # noqa: E501
        """
