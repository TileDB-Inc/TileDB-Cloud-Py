...
class Layout(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Layout of array., must be one of ["row-major", "col-major", "global-order", "unordered", ]  # noqa: E501

        Keyword Args:
            value (str): Layout of array., must be one of ["row-major", "col-major", "global-order", "unordered", ]  # noqa: E501
