...
class GroupMemberAssetType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """GroupMemberAssetType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Specific file types of group members., must be one of ["group", "array", "notebook", "dashboard", "user_defined_function", "ml_model", "file", ]  # noqa: E501

        Keyword Args:
            value (str): Specific file types of group members., must be one of ["group", "array", "notebook", "dashboard", "user_defined_function", "ml_model", "file", ]  # noqa: E501
