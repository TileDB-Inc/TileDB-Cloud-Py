...
class TGSQLNodeData(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "init_commands": ([str],),  # noqa: E501
            "query": (str,),  # noqa: E501
            "parameters": ([dict],),  # noqa: E501
    ...
    attribute_map = {
        "init_commands": "init_commands",  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            init_commands ([str]): The commands to execute before running the query itself.. [optional]  # noqa: E501
            query (str): The text of the SQL query to execute. Parameters are substituted in for `?`s, just as in a regular MariaDB query. . [optional]  # noqa: E501
            parameters ([dict]): The parameters to substitute in for arguments in the `query`. Fixed-length. Arguments must be in JSON format. . [optional]  # noqa: E501
