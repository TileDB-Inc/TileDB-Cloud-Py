...
class UDFType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): UDF Type., must be one of ["multi_array", "single_array", "generic", ]  # noqa: E501

        Keyword Args:
            value (str): UDF Type., must be one of ["multi_array", "single_array", "generic", ]  # noqa: E501
