...
class PublicShareFilter(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PublicShareFilter - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Query parameter to get array metadatas., must be one of ["exclude", "only", ]  # noqa: E501

        Keyword Args:
            value (str): Query parameter to get array metadatas., must be one of ["exclude", "only", ]  # noqa: E501
