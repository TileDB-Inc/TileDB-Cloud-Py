...
class OrganizationRoles(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): role user has in organization., must be one of ["owner", "admin", "read_write", "read_only", ]  # noqa: E501

        Keyword Args:
            value (str): role user has in organization., must be one of ["owner", "admin", "read_write", "read_only", ]  # noqa: E501
