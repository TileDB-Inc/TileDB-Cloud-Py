...
class TaskGraphLogStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TaskGraphLogStatus - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The status of a given task graph execution.., must be one of ["submitted", "running", "idle", "abandoned", "succeeded", "failed", "cancelled", ]  # noqa: E501

        Keyword Args:
            value (str): The status of a given task graph execution.., must be one of ["submitted", "running", "idle", "abandoned", "succeeded", "failed", "cancelled", ]  # noqa: E501
