...
class PricingUnitLabel(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PricingUnitLabel - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Unit label., must be one of ["byte", "second", ]  # noqa: E501

        Keyword Args:
            value (str): Unit label., must be one of ["byte", "second", ]  # noqa: E501
