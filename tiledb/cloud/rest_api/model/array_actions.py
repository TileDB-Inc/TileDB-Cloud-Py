...
class ArrayActions(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ArrayActions - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): actions a user can take on an array., must be one of ["read", "write", "edit", "read_array_logs", "read_array_info", "read_array_schema", ]  # noqa: E501

        Keyword Args:
            value (str): actions a user can take on an array., must be one of ["read", "write", "edit", "read_array_logs", "read_array_info", "read_array_schema", ]  # noqa: E501
