...
class InvitationStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """InvitationStatus - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): List of values that InvitationStatus can take., must be one of ["PENDING", "ACCEPTED", ]  # noqa: E501

        Keyword Args:
            value (str): List of values that InvitationStatus can take., must be one of ["PENDING", "ACCEPTED", ]  # noqa: E501
