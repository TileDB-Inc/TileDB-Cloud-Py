...
class InvitationArrayShareEmail(ModelNormal):
    ...
    def _from_openapi_data(cls, actions, invitee_email, *args, **kwargs):  # noqa: E501
        """InvitationArrayShareEmail - a model defined in OpenAPI

        Args:
            actions ([ArrayActions]): List of permitted actions
            invitee_email ([str]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, actions, invitee_email, *args, **kwargs):  # noqa: E501
        """InvitationArrayShareEmail - a model defined in OpenAPI
