...
class GroupActions(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """GroupActions - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): actions a user can take on a group., must be one of ["read", "write", "edit", ]  # noqa: E501

        Keyword Args:
            value (str): actions a user can take on a group., must be one of ["read", "write", "edit", ]  # noqa: E501
