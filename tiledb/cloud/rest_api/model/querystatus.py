...
class Querystatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Status of query., must be one of ["FAILED", "COMPLETED", "INPROGRESS", "INCOMPLETE", "UNINITIALIZED", ]  # noqa: E501

        Keyword Args:
            value (str): Status of query., must be one of ["FAILED", "COMPLETED", "INPROGRESS", "INCOMPLETE", "UNINITIALIZED", ]  # noqa: E501
