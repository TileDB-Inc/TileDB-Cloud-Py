...
class NamespaceActions(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """NamespaceActions - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): actions a user can take on an organization., must be one of ["read", "write", "create", "delete", "edit", "read_array_logs", "read_job_logs", "read_object_logs", "run_job", "delete_organization", "edit_organization", "edit_billing", ]  # noqa: E501

        Keyword Args:
            value (str): actions a user can take on an organization., must be one of ["read", "write", "create", "delete", "edit", "read_array_logs", "read_job_logs", "read_object_logs", "run_job", "delete_organization", "edit_organization", "edit_billing", ]  # noqa: E501
