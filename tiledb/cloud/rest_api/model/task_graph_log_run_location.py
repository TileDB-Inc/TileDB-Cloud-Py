...
class TaskGraphLogRunLocation(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TaskGraphLogRunLocation - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The location where an individual node of a task graph is executed. ., must be one of ["server", "client", "virtual", ]  # noqa: E501

        Keyword Args:
            value (str): The location where an individual node of a task graph is executed. ., must be one of ["server", "client", "virtual", ]  # noqa: E501
