...
class UDFCopy(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UDFCopy - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            output_uri (str): output location of the TileDB File. [optional]  # noqa: E501
            namespace (str): namespace to register the copy. If empty use the namespace of the request user. [optional]  # noqa: E501
            name (str): name to set for the copy. If empty use the name as the original udf, if it not already used in the namespace. [optional]  # noqa: E501
        """
