...
class InvitationType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): List of values that InvitationType can take., must be one of ["ARRAY_SHARE", "JOIN_ORGANIZATION", ]  # noqa: E501

        Keyword Args:
            value (str): List of values that InvitationType can take., must be one of ["ARRAY_SHARE", "JOIN_ORGANIZATION", ]  # noqa: E501
