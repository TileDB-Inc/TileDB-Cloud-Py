...
class SSOProvider(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SSOProvider - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Single sign on provider., must be one of ["github", "google", "stripe", "okta", ]  # noqa: E501

        Keyword Args:
            value (str): Single sign on provider., must be one of ["github", "google", "stripe", "okta", ]  # noqa: E501
