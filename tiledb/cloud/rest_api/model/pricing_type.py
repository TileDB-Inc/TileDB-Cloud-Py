...
class PricingType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PricingType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Pricing types., must be one of ["egress", "access", ]  # noqa: E501

        Keyword Args:
            value (str): Pricing types., must be one of ["egress", "access", ]  # noqa: E501
