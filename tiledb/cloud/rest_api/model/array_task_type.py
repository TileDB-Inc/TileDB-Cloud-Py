...
class ArrayTaskType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ArrayTaskType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Synchronous Task Type., must be one of ["SQL", "UDF", "QUERY", "GENERIC_UDF", ]  # noqa: E501

        Keyword Args:
            value (str): Synchronous Task Type., must be one of ["SQL", "UDF", "QUERY", "GENERIC_UDF", ]  # noqa: E501
