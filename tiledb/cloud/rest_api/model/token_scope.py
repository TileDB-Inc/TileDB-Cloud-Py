...
class TokenScope(ModelSimple):
    ...
    allowed_values = {
        ("value",): {
            ...
            "*": "*",
            "USER:READ": "user:read",
            "USER:READ-WRITE": "user:read-write",
            "USER:ADMIN": "user:admin",
            "ARRAY:READ": "array:read",
            "ARRAY:READ-WRITE": "array:read-write",
            "ARRAY:ADMIN": "array:admin",
            "ORGANIZATION:READ": "organization:read",
            "ORGANIZATION:READ-WRITE": "organization:read-write",
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): An api token scope available for creation., must be one of ["password_reset", "confirm_email", "*", "user:read", "user:read-write", "user:admin", "array:read", "array:read-write", "array:admin", "organization:read", "organization:read-write", "organization:admin", "group:read", "group:read-write", "group:admin", ]  # noqa: E501

        Keyword Args:
            value (str): An api token scope available for creation., must be one of ["password_reset", "confirm_email", "*", "user:read", "user:read-write", "user:admin", "array:read", "array:read-write", "array:admin", "organization:read", "organization:read-write", "organization:admin", "group:read", "group:read-write", "group:admin", ]  # noqa: E501
