...
class UDFActions(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """UDFActions - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): actions a user can take on a UDF., must be one of ["fetch_udf", "share_udf", ]  # noqa: E501

        Keyword Args:
            value (str): actions a user can take on a UDF., must be one of ["fetch_udf", "share_udf", ]  # noqa: E501
