...
class Token(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            token (str): A api token. [optional]  # noqa: E501
            name (str): Name of token to revoke. [optional]  # noqa: E501
            issued_at (datetime): datetime the token was created. [optional]  # noqa: E501
            expires_at (datetime): datetime the token when token will expire. [optional]  # noqa: E501
            scope (str): Optional scope to limit token, defaults to all permissions, current supported values are password_reset or *. [optional] if omitted the server will use the default value of "*"  # noqa: E501
        """
