...
class TokenRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            expires (datetime): Expiration date for token, if empty token defaults to 30 minutes. [optional]  # noqa: E501
            name (str): Optional name for token, if the name already exists for the user it will be auto incremented (i.e. myToken-1). [optional]  # noqa: E501
