...
class ArrayTaskStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ArrayTaskStatus - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Status of array task., must be one of ["QUEUED", "FAILED", "COMPLETED", "RUNNING", "DENIED", "UNKNOWN", "CANCELLED", ]  # noqa: E501

        Keyword Args:
            value (str): Status of array task., must be one of ["QUEUED", "FAILED", "COMPLETED", "RUNNING", "DENIED", "UNKNOWN", "CANCELLED", ]  # noqa: E501
