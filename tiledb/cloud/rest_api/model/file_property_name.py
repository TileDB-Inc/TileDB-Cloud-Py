...
class FilePropertyName(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """FilePropertyName - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): File property assigned to a specific file (array)., must be one of ["image", "size", "code_block", "udf_language", "is_dashboard", ]  # noqa: E501

        Keyword Args:
            value (str): File property assigned to a specific file (array)., must be one of ["image", "size", "code_block", "udf_language", "is_dashboard", ]  # noqa: E501
