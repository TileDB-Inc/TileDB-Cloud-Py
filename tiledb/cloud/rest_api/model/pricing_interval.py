...
class PricingInterval(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PricingInterval - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Interval for pricing. if omitted defaults to "month", must be one of ["month", ]  # noqa: E501

        Keyword Args:
            value (str): Interval for pricing. if omitted defaults to "month", must be one of ["month", ]  # noqa: E501
