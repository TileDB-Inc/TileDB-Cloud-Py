...
class GroupMemberType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """GroupMemberType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): File types that can be included in groups., must be one of ["group", "array", ]  # noqa: E501

        Keyword Args:
            value (str): File types that can be included in groups., must be one of ["group", "array", ]  # noqa: E501
