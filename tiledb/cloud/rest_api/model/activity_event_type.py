...
class ActivityEventType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ActivityEventType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Type of activity logged., must be one of ["read_schema", "max_buffer_sizes", "non_empty_domain", "query_read", "query_write", "create", "delete", "register", "deregister", "udf", "array_metadata_get", "array_metadata_update", "estimated_result_sizes", ]  # noqa: E501

        Keyword Args:
            value (str): Type of activity logged., must be one of ["read_schema", "max_buffer_sizes", "non_empty_domain", "query_read", "query_write", "create", "delete", "register", "deregister", "udf", "array_metadata_get", "array_metadata_update", "estimated_result_sizes", ]  # noqa: E501
