...
class UDFLanguage(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """UDFLanguage - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): UDF Type., must be one of ["python", "r", ]  # noqa: E501

        Keyword Args:
            value (str): UDF Type., must be one of ["python", "r", ]  # noqa: E501
