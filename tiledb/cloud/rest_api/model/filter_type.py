...
class FilterType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): TileDB filter types., must be one of ["FILTER_NONE", "FILTER_GZIP", "FILTER_ZSTD", "FILTER_LZ4", "FILTER_RLE", "FILTER_BZIP2", "FILTER_DOUBLE_DELTA", "FILTER_BIT_WIDTH_REDUCTION", "FILTER_BITSHUFFLE", "FILTER_BYTESHUFFLE", "FILTER_POSITIVE_DELTA", ]  # noqa: E501

        Keyword Args:
            value (str): TileDB filter types., must be one of ["FILTER_NONE", "FILTER_GZIP", "FILTER_ZSTD", "FILTER_LZ4", "FILTER_RLE", "FILTER_BZIP2", "FILTER_DOUBLE_DELTA", "FILTER_BIT_WIDTH_REDUCTION", "FILTER_BITSHUFFLE", "FILTER_BYTESHUFFLE", "FILTER_POSITIVE_DELTA", ]  # noqa: E501
