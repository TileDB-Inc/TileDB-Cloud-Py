...
class PricingCurrency(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PricingCurrency - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Currency of pricing. if omitted defaults to "USD", must be one of ["USD", ]  # noqa: E501

        Keyword Args:
            value (str): Currency of pricing. if omitted defaults to "USD", must be one of ["USD", ]  # noqa: E501
