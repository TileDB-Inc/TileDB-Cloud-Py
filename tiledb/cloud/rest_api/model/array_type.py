...
class ArrayType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ArrayType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): TileDB array type., must be one of ["dense", "sparse", ]  # noqa: E501

        Keyword Args:
            value (str): TileDB array type., must be one of ["dense", "sparse", ]  # noqa: E501
