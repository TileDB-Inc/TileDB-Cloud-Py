...
class FileType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): File types represented as TileDB arrays., must be one of ["notebook", "user_defined_function", "ml_model", "file", "registered_task_graph", ]  # noqa: E501

        Keyword Args:
            value (str): File types represented as TileDB arrays., must be one of ["notebook", "user_defined_function", "ml_model", "file", "registered_task_graph", ]  # noqa: E501
