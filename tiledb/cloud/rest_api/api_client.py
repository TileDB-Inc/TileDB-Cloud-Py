...
from tiledb.cloud.rest_api.model_utils import check_allowed_values
...
from tiledb.cloud.rest_api.model_utils import deserialize_file
from tiledb.cloud.rest_api.model_utils import file_type
from tiledb.cloud.rest_api.model_utils import model_to_dict
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ArrayApi()
        api_instance.array_activity_log  # this is an instance of the class Endpoint
        api_instance.array_activity_log()  # this invokes api_instance.array_activity_log.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.array_activity_log.callable or self.callable in this class
