...
> list[ArrayFavorite] list_array_favorites_uuids()
...
> list[MLModelFavorite] list_ml_model_favorites_uuids()
...
> list[NotebookFavorite] list_notebook_favorites_uuids()
...
> list[UDFFavorite] list_udf_favorites_uuids()
