...
[**resubmit_task_graph_execution**](RegisteredTaskGraphsApi.md#resubmit_task_graph_execution) | **POST** /v1/taskgraphs/{namespace}/executions/{id}/resubmit | 
...
[**stop_task_graph**](RegisteredTaskGraphsApi.md#stop_task_graph) | **POST** /v1/taskgraphs/{namespace}/executions/{id}/stop | 
...
id = 'id_example' # str | The UUID of the task graph entry.
    ...
    try:
        ...
        print("Exception when calling RegisteredTaskGraphsApi->resubmit_task_graph_execution: %s\n" % e)
```
...
id = 'id_example' # str | The UUID of the task graph entry.
    ...
    try:
        ...
        print("Exception when calling RegisteredTaskGraphsApi->stop_task_graph: %s\n" % e)
```
